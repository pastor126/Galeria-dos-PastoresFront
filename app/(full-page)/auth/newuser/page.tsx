                ...
                >
                    <div className="w-full surface-card py-8 px-5 sm:px-8" style={{ borderRadius: '53px' }}>
                        <div className="text-center mb-5">
                            ...
                            <div className="text-900 text-3xl font-medium mb-3">Cadastro de Usuário</div>
                        ...
                        <div>
                            ...
                            <Password inputId="senha" placeholder="Password" toggleMask className="w-full mb-5" inputClassName="w-full p-3 md:w-30rem"
                            value={usuario.senha}
